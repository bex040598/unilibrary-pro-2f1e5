        ...
        <div className="bod-footer-inner">
          ...
          <div className="bod-footer-brand">
            ...
            <div className="bod-footer-socials">
              <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="bod-social" aria-label="Telegram">
              ...
              <a href="#" className="bod-social" aria-label="Instagram">
          ...
          <div className="bod-footer-col">
            ...
            <a href="tel:+998900080498" className="bod-footer-contact">
